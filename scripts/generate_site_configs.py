...
SEARCH_PATTERNS = [
    ...
    {"keywords": ["bato"],
     "template": "https://{domain}/search?q={KEYWORD}"},
    {"keywords": ["mangahere", "fanfox"],
     "template": "https://{domain}/search?keyword={KEYWORD}"},
    {"keywords": ["webtoon"],
     "template": "https://{domain}/search?keyword={KEYWORD}"},
    {"keywords": ["comic-walker", "comicdays"],
     "template": "https://{domain}/search?q={KEYWORD}"},
    {"keywords": ["naver", "kakao", "lezhin", "bomtoon", "ridi"],
     "template": "https://{domain}/search?keyword={KEYWORD}"},
    {"keywords": ["tapas"],
     "template": "https://{domain}/search?q={KEYWORD}"},
]
...
SEED_PATTERNS = [
    {"keywords": ["manga", "manhwa", "comic", "read", "scan"],
     "paths": ["/", "/manga", "/latest", "/manga-list", "/genre"]},
    ...
    {"keywords": ["comick"],
     "paths": ["/", "/home", "/list?sort=update", "/list?sort=popular"]},
    {"keywords": ["mangadex"],
     "paths": ["/", "/titles/latest", "/titles/popular"]},
    {"keywords": ["bato"],
     "paths": ["/", "/browse", "/latest"]},
    {"keywords": ["mangafire"],
     "paths": ["/", "/filter", "/updated", "/newest"]},
    {"keywords": ["asura"],
     "paths": ["/", "/comics", "/latest"]},
    {"keywords": ["webtoon"],
     "paths": ["/en/", "/en/dailySchedule", "/en/originals", "/en/canvas"]},
    {"keywords": ["tapas"],
     "paths": ["/", "/comics", "/new"]},
    {"keywords": ["mangahere", "fanfox"],
     "paths": ["/", "/latest/", "/mangalist/"]},
    {"keywords": ["mangakakalot", "manganato", "chapmanganato", "mangase"],
     "paths": ["/", "/manga_list/", "/latest/"]},
    {"keywords": ["comic-walker", "comicdays"],
     "paths": ["/", "/series"]},
    {"keywords": ["naver", "kakao", "lezhin", "bomtoon", "ridi"],
     "paths": ["/", "/list", "/popular"]},

...
SECTION_CONFIG = {
    ...
    "blacklist": {
        "name": "app blacklist (domains/titles/words)",
        "source_template": "generated/app_blacklist.{lang}.json",
        "url_template": f"{REPO_RAW_BASE}/generated/app_blacklist.{{lang}}.json",
    },
}

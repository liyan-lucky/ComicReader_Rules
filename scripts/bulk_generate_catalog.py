...
CATEGORY_RULES = [
    {"id": "dongzuo", "name": "动作", "keywords": ["动作", "战斗", "热血", "竞技", "杀手", "action", "battle", "fight"]},
    {"id": "maoxian", "name": "冒险", "keywords": ["冒险", "探险", "秘境", "地下城", "adventure", "dungeon", "quest"]},
    {"id": "lianai", "name": "恋爱", "keywords": ["恋爱", "爱情", "甜宠", "告白", "love", "romance", "romantic"]},
    {"id": "xiju", "name": "喜剧", "keywords": ["喜剧", "搞笑", "沙雕", "爆笑", "comedy", "funny", "gag"]},
    {"id": "juqing", "name": "剧情", "keywords": ["剧情", "家庭", "悲剧", "心理", "drama", "dramatic", "family"]},
    {"id": "qihuan", "name": "奇幻", "keywords": ["奇幻", "魔法", "魔王", "恶魔", "fantasy", "magic", "demon", "dragon"]},
    {"id": "xiaoyuan", "name": "校园", "keywords": ["校园", "校花", "同桌", "学生", "school", "campus", "classmate"]},
    {"id": "richang", "name": "日常", "keywords": ["日常", "生活", "休闲", "治愈", "slice of life", "daily life", "healing"]},
    {"id": "wuxia_gedou", "name": "武侠/格斗", "keywords": ["武侠", "江湖", "侠客", "格斗", "kung fu", "martial arts"]},
    {"id": "kehuan", "name": "科幻", "keywords": ["科幻", "机甲", "末世", "星际", "sci-fi", "mecha", "robot", "apocalypse"]},
    {"id": "kongbu", "name": "恐怖", "keywords": ["恐怖", "惊悚", "灵异", "鬼", "horror", "thriller", "ghost"]},
    {"id": "xuanyi", "name": "悬疑", "keywords": ["悬疑", "推理", "侦探", "谜案", "mystery", "detective", "crime"]},
    {"id": "lishi_gufeng", "name": "历史/古风", "keywords": ["历史", "古风", "古代", "宫廷", "historical", "ancient", "palace"]},
    {"id": "dushi", "name": "都市", "keywords": ["都市", "职场", "总裁", "老板", "urban", "ceo", "office", "doctor"]},
    {"id": "xiuxian", "name": "修仙", "keywords": ["修仙", "修真", "仙侠", "仙尊", "cultivation", "cultivator", "immortal"]},
